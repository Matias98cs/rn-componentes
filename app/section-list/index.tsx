    ...
    <ThemedView margin>
      <ThemedCard>
        <SectionList
          ...
          ListHeaderComponent={() => (
            <ThemedText type="h1" className="text-center font-bold mb-3">
              Personajes
            </ThemedText>
          )}
          renderSectionHeader={({ section }) => (
            <ThemedText
              type="h1"
              className="bg-ligth-background dark:bg-dark-background p-2 rounded-xl"
            >
              {section.title}
            </ThemedText>
          )}
          ...
          ListFooterComponent={() => (
            <ThemedText
              type="h1"
              className="font-bold bg-ligth-background dark:bg-dark-background p-2 mb-10 rounded"
            >
